    ...
    <div className="texture-v3 bg-primary ">
      <footer className="footer px-10 pt-10 pb-5 font-semibold">
        <nav>
          ...
          <a className="link link-hover text-white hover:text-pink-600">Branding</a>
          <a className="link link-hover text-white hover:text-pink-600">Design</a>
          <a className="link link-hover text-white hover:text-pink-600">Marketing</a>
          <a className="link link-hover text-white hover:text-pink-600">Advertisement</a>
        </nav> 
        <nav>
          <h6 className="footer-title text-slate-900">Company</h6> 
          <a href="/" className="link link-hover text-white hover:text-pink-600">About us</a>
          <a href="/discover" className="link link-hover text-white hover:text-pink-600">Discover</a>
          <a href="/support" className="link link-hover text-white hover:text-pink-600">Support</a>
          <a href="/shop" className="link link-hover text-white hover:text-pink-600">Shop</a>
        </nav> 
        <nav>
          <h6 className="footer-title text-slate-900">Legal</h6> 
          <a className="link link-hover text-white hover:text-pink-600">Terms of use</a>
          <a className="link link-hover text-white hover:text-pink-600">Privacy policy</a>
          <a className="link link-hover text-white hover:text-pink-600">Cookie policy</a>
        </nav>
      </footer> 
      <footer className="footer px-10 py-4 border-t text-slate-800 border-slate-800">
        ...
        <nav className="md:place-self-center md:justify-self-end">
          <div className="grid grid-flow-col gap-4">
            ...
            <a className="cursor-pointer hover:text-pink-600"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></a>
