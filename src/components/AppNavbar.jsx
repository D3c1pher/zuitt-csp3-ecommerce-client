...
import { BellIcon, UserIcon, ShoppingCartIcon } from "@heroicons/react/24/outline";
        ...
        <>
            ...
            <div className="navbar bg-base-100">
                ...
                <div className="navbar-start">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            {
                                ...
                                :
                                <>
                                    <li><Link to="/shop">Product Lists</Link></li>
                                    <li><Link to="/blog">Blog Lists</Link></li>
                                    <li><Link to="/users">User Lists</Link></li>
                                </>
                            }
                        </ul>
                    </div>
                    ...
                    {/* Brand */} 
                    <Link to="/" className="btn btn-ghost text-xl">InspiredWeaver</Link>
                </div>
                    ...
                    {user && user.id !== null && !user.isAdmin && (
                        <>
                            ...
                            <button className="btn btn-ghost btn-circle">
                                <BellIcon className="h-5 w-5" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                            </button>
