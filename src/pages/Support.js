...
export default function Support() {
  ...
  return (
    <div className="isolate bg-base-100 px-6 py-24">
      <div
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-black tracking-wide sm:text-4xl">CONTACT SUPPORT</h2>
        <p className="mt-2 text-lg leading-8 text-gray-500">
          Contact us for any issues. We are open to help.
        </p>
      </div>
      <form action="/" className="mx-auto mt-10 max-w-xl sm:mt-14">
            ...
            <div className="relative mt-2.5">
              <div className="absolute inset-y-0 left-0 flex items-center">
                <select
                  id="country"
                  name="country"
                  className="h-full rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm appearance-none"
                >
                  <option>PH</option>
                </select>
                <ChevronDownIcon
              ...
              <input
                ...
                id="phone-number"
                autoComplete="tel"
                className="block w-full rounded-md border-0 px-3.5 py-2 pl-20 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div className="sm:col-span-2">
